...
class help(commands.Cog):
    ...
    async def help(self, ctx):
        em = discord.Embed(
                description=f"The '.help' command provides help and information about the available commands.",
        ...
        em.add_field(name="Other", value="sinfo, getip, iptrack, uinfo, dm, weather")
